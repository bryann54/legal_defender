import 'package:legal_defender/core/api_client/models/server_error.dart';
...
class ServerFailure extends Failure {
  ...
  @override
  String toString() {
    return badResponse?.getErrorMessage() ?? 'something Went Wrong';
  }
}
...
class ClientFailure extends Failure {
  ...
  const ClientFailure({required this.error, required message});
